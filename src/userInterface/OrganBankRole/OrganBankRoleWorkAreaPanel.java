 ...
 * @author sahebsingh
 */
public class OrganBankRoleWorkAreaPanel extends javax.swing.JPanel {

    /**
     * Creates new form OrganBankRoleWorkAreaPanel
     */
    ...
    public OrganBankRoleWorkAreaPanel(JPanel userProcessContainer,UserAccount account, OrganBankOrganization organization, Enterprise enterprise, EcoSystem system ,Network network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Email", "Contact", "Address", "Type Of Organ", "Accepted By"
            }
        ));
        ...
        try {
            ...
            for (Organization o : orgs) {
                if (o instanceof OrganBankOrganization) {
                    userProcessContainer.add("TrackRequestStatusPanel", new userInterface.OrganBankRole.TrackRequestStatusPanel(userProcessContainer, userAccount, enterprise, o.getWorkQueue().getDoctorWorkRequestList()));
